...
class Information extends Common{
    ...
    public function add(Request $request){
        if($request->isPost()){
            ...
            if($res){
                $this->success('文章添加成功','information/index.html');
            }else{
    ...
    public function del(Request $request){
        ...
        $res=$this->db->del($id);
        if($res){
            $this->success('文章更新状态成功','information/index.html');
        }else{
            $this->error('文章更新状态失败,请尝试重新更新！','information/index.html');
        }
    }
    public function edit(Request $request){
        if($request->isPost()){
            ...
            $res=$this->db->edit(input('post.'),$savename);
            if($res){
                $this->success('文章更新成功','information/index.html');
            }else{
                $this->error('文章更新失败,请重新更新！','information/index.html');
            }
        }
        $id=intval(input('get.id'));
