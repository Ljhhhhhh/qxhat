<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\xampp\htdocs\qxhat\public/../application/index\view\information\index.html";i:1508570200;s:66:"E:\xampp\htdocs\qxhat\public/../application/index\view\common.html";i:1508569030;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<ul class="nav nav-pills" id="info-tabs">
    <li role="presentation" ><a href="<?php echo url('/information'); ?>">全部</a></li>
    <?php if(is_array($category) || $category instanceof \think\Collection): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cc): $mod = ($i % 2 );++$i;?>
    <li role="presentation" ><a href="<?php echo url('/information_category',['id'=>$cc['category_id']]); ?>"><?php echo $cc['category_name']; ?></a></li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
<hr>
<?php if(is_array($information) || $information instanceof \think\Collection): $i = 0; $__LIST__ = $information;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
<ul class="info_list">
    <li>
        <a href="<?php echo url('/information_show',['id'=>$vo['id']]); ?>" class="row">
            <div class="thumb col-sm-3 col-xs-12"><img src="/uploads/<?php echo $vo['thumb']; ?>"></div>
            <h3 class="col-sm-9 col-xs-12"><?php echo $vo['title']; ?></h3>
            <p class="col-sm-9 col-xs-12"><?php echo $vo['abstract']; ?></p>
        </a>
    </li>
</ul>
<?php endforeach; endif; else: echo "" ;endif; ?>
<?php echo $information->render(); ?>
