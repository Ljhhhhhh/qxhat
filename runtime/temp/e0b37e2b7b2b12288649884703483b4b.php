<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"E:\xampp\htdocs\qxhat\public/../application/admin\view\product_brand\index.html";i:1507517490;s:66:"E:\xampp\htdocs\qxhat\public/../application/admin\view\header.html";i:1507276203;s:64:"E:\xampp\htdocs\qxhat\public/../application/admin\view\menu.html";i:1507600780;s:66:"E:\xampp\htdocs\qxhat\public/../application/admin\view\footer.html";i:1507097252;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加资讯" href="<?php echo url('productBrand/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加品牌</a>
				</span>
                <span class="r">共有品牌：<strong><?php echo $count; ?></strong> 条</span>
            </div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <?php if(is_array($brandList) || $brandList instanceof \think\Collection): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr class="text-c">
                        <td><?php echo $vo['brand_id']; ?></td>
                        <td class="text-l"><?php echo $vo['brand_name']; ?></td>
                        <td class="text-l"><?php echo $vo['brand_name_en']; ?></td>
                        <td class="brand_list_img"><img src="/uploads/<?php echo $vo['brand_logo']; ?>" alt=""></td>
                        <td><?php echo $vo['brand_describe']; ?></td>
                        <td class="f-14 td-manage">
                            <a href="<?php echo url('productBrand/edit',['id'=>$vo['brand_id']]); ?>" style="text-decoration:none" class="ml-5"  title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a></td>
                    </tr>
