<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"E:\xampp\htdocs\qxhat\public/../application/index\view\introduce\join.html";i:1508568530;s:66:"E:\xampp\htdocs\qxhat\public/../application/index\view\common.html";i:1508569030;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    $(function () {
        $("#join_btn").click(function (e) {
            ...
            new serviceForm({
                obj:'#join_form',
                url:"<?php echo url('introduce/add'); ?>",
                name:'name',
                name_verify:true,
                mobile:'mobile',
                email:'email',
