<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"E:\xampp\htdocs\qxhat\public/../application/admin\view\product_brand\edit.html";i:1507459505;s:66:"E:\xampp\htdocs\qxhat\public/../application/admin\view\header.html";i:1507276203;s:64:"E:\xampp\htdocs\qxhat\public/../application/admin\view\menu.html";i:1507547891;s:66:"E:\xampp\htdocs\qxhat\public/../application/admin\view\footer.html";i:1507097252;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('productBrand/doEdit'); ?>" method="post" enctype='multipart/form-data'>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>品牌名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $brand['brand_name']; ?>" placeholder="" name="brand_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>品牌英文名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $brand['brand_name_en']; ?>" placeholder="" name="brand_name_en">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" id="uploadForm">
                <div class="fileinput fileinput-new" data-provides="fileinput" id="exampleInputUpload">
                    <div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
                        <img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="/uploads/<?php echo $brand['brand_logo']; ?>" alt=""/>
                    </div>
                    ...
                    <div>
                        <span class="btn btn-primary radius btn-file">
                            ...
                            <input type="file" value="<?php echo $brand['brand_logo']; ?>" name="brand_logo" id="picID" accept="image/gif,image/jpeg,image/x-png"/>
                        </span>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="brand_describe" id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo $brand['brand_describe']; ?></textarea>
            </div>
        </div>
        <input type="hidden" name="brand_id" value="<?php echo $brand_id; ?>">
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button class="btn btn-primary radius" type="submit" id="bbb"><i class="Hui-iconfont">&#xe632;</i> 更新</button>
